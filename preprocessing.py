...
for cv in cvs:
    ...
    train_neg_file = f"data/data_not_token/fold_{cv}/train_nhan_0.txt"
    train_neu_file = f"data/data_not_token/fold_{cv}/train_nhan_2.txt"

    test_pos_file = f"data/data_not_token/fold_{cv}/test_nhan_1.txt"
    test_neg_file = f"data/data_not_token/fold_{cv}/test_nhan_0.txt"
    test_neu_file = f"data/data_not_token/fold_{cv}/test_nhan_2.txt"

    open_files = [train_pos_file, train_neg_file, train_neu_file,
                  test_pos_file, test_neg_file, test_neu_file]

    # Đường dẫn lưu file
    train_pos_save = f"data/data_not_token/fold_{cv}/train_pos"
    train_neg_save = f"data/data_not_token/fold_{cv}/train_neg"
    train_neu_save = f"data/data_not_token/fold_{cv}/train_neu"

    test_pos_save = f"data/data_not_token/fold_{cv}/test_pos"
    test_neg_save = f"data/data_not_token/fold_{cv}/test_neg"
    test_neu_save = f"data/data_not_token/fold_{cv}/test_neu"
